...
/**
 * Created by Sidharth on 01-Jul-16.
 */
public class DB_Apply {

    private static final String DATABASE_NAME="lms_db_apply";
    private static final String DATABASE_TABLE_NAME="apply";
    ...
    public DB_Apply(Context c){
        ourContext=c;
    }

    public DB_Apply open() throws SQLException {
